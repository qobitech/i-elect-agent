...
import { type IReportResultRequest } from '../../../interface/state/IElectionState';
...
const assignmentDetails = [
	{ label: '#1', value: 'BVAS issues' },
	{ label: '#2', value: 'Result not submitting' },
	{ label: '#3', value: 'Violence / intimidation' },
	{ label: '#4', value: 'Ballot box snatching' },
	{ label: '#5', value: 'Result sheet errors' },
	{ label: '#6', value: 'Late arrival' },
	{ label: '#7', value: 'Voters missing' },
	{ label: '#8', value: 'Vote buying' },
	{ label: '#9', value: 'Wrong/short ballot papers' },
	{ label: '#10', value: 'Unauthorized persons' },
];
...
const ReportIssueStage = () => {
	...
	const rsPropsData = rsProps?.data as IReportResultRequest;
	...
	const onSendReport = () => {
		actions?.create_ElectionReeport({
			data: {
				...rsPropsData,
				comment: reportIssues.report.body,
				flag: reportIssues.report.title,
				createdAt: '',
				updatedAt: '',
			},
			onSuccess: () => {
		...
		<>
			...
			>
				<div className='f-row-10 w-100 text-left justify-content-between align-items-center'>
					<h3 className='header-body-text m-0'>Report Election Result Issue</h3>
				</div>
